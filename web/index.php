...
<!-- Start coding here -->
<?php
$folder = "images/images_slideshow"; // Change this to your image folder path
...
<div class="main-content-container">
    ...
    <div class="side-navbar">
        <p>SUMMER 2025</p>
        <ul>
            <li style="background: #9db4c0; font-weight: 600; color: #253237; border-radius: 5px;"><a href="../index.php">NEW ARRIVALS</a></li>
